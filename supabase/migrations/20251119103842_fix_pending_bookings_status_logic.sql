-- Corriger la logique de mise à jour des statuts
...
BEGIN
    ...
    -- 2. Mettre à jour les réservations CONFIRMED qui sont actuellement en cours -> EN_COURS
    UPDATE bookings b
    SET status = 'en_cours'
    FROM hairdresser_services hs
    WHERE b.service_id = hs.id
    ...
    -- 3. Mettre à jour les réservations EN_COURS qui sont maintenant terminées -> COMPLETED
    UPDATE bookings b
