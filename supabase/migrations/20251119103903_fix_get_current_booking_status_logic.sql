-- Corriger également la fonction get_current_booking_status pour suivre la même logique
...
BEGIN
    ...
    -- Vérifier si la réservation CONFIRMED est en cours
    ...
    -- Vérifier si la réservation EN_COURS est maintenant terminée
